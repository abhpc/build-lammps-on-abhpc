...
YES_INC="ASPHERE ATC BOCS BODY BPM BROWNIAN CG-DNA CG-SDK CLASS2 COLLOID CORESHELL DIELECTRIC DIFFRACTION DIPOLE DPD-BASIC DPD-MESO DPD-REACT DPD-SMOOTH DRUDE EFF EXTRA-COMPUTE EXTRA-DUMP EXTRA-FIX EXTRA-MOLECULE EXTRA-PAIR FEP GPU GRANULAR INTERLAYER KOKKOS KSPACE LATBOLTZ MACHDYN MANIFOLD MANYBODY MC MEAM MGPT MISC ML-IAP ML-RANN ML-SNAP MOFFF MOLECULE MPIIO OPENMP OPT ORIENT PERI PHONON PLUGIN PTM QEQ QTB REACTION REAXFF REPLICA RIGID SHOCK SMTBQ SPH SPIN SRD TALLY UEF VORONOI YAFF"
